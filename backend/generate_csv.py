...
dummy_products = [
    ...
    { "id": 51, "name": "Pearl Millet Flour", "price": 65, "image": "/img/maida.jpg", "description": "Made from premium MP wheat used for soft chapatis and rotis." },
    { "id": 52, "name": "White Sorghum Flour", "price": 76, "image": "/img/rice.jpg", "description": "Refined white flour for bakery items samosas pastries." },
    { "id": 53, "name": "Finger Millet Flour", "price": 100, "image": "/img/Laxmi-Besan-Chickpea-Flour_b175f891-e632-4aec-990b-57825615f3a2.bf98feae9e4d12f9a30d7bd0b1ac1117.avif", description: "Made from Bengal gram used for pakoras sweets and snacks." },
    { "id": 54, "name": "Fine Corn Flour", "price": 60, "image": "/img/multi.jpg", "description": "Gluten-free used in modak dosa and South Indian dishes." },
    { "id": 55, "name": "Bombay Rava", "price": 120, "image": "/img/rice.jpg", "description": "Used in ragi dosa porridge highly nutritious." },
    { "id": 56, "name": "Barley Whole Flour", "price": 80, "image": "/img/wheat.jpg", "description": "Used for making jau roti good for digestion and weight loss." },
    { "id": 57, "name": "Coarse Chana Besan", "price": 96, "image": "/img/maida.jpg", "description": "Smooth texture used for sweets like laddus dhokla and kadhi." },
    { "id": 58, "name": "Aashirvaad MP Sharbati", "price": 110, "image": "/img/rice.jpg", "description": "Slightly grainy ideal for pakoras chilla and traditional recipes" },
    { "id": 59, "name": "24 Mantra Organic", "price": 80, "image": "/img/multi.jpg", "description": "Dry roasted gram flour with nutty flavor used in laddus barfi etc." },
    { "id": 60, "name": "Kabuli Chana Besan", "price": 67, "image": "/img/Laxmi-Besan-Chickpea-Flour_b175f891-e632-4aec-990b-57825615f3a2.bf98feae9e4d12f9a30d7bd0b1ac1117.avif", "description": "Made from small desi chana richer taste and aroma." }
]
